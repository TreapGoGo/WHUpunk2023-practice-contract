...
contract CreateSubscription is Script {
    function createSubscriptionUsingConfig() public returns (uint64) {
        ...
        (,, uint256 deployerKey,, address vrfCoordinator,,,,) = helperConfig.activeNetworkConfig();
...
contract FundSubscription is Script {
    ...
    function fundSubscriptionUsingConfig() public {
        HelperConfig helperConfig = new HelperConfig();
        (,, uint256 deployerKey,, address vrfCoordinator,, uint64 subscriptionId,, address link) =
...
contract AddConsumer is Script {
    ...
    function addConsumerUsingConfig(address raffle) public {
        HelperConfig helperConfig = new HelperConfig();
        (,, uint256 deployerKey,, address vrfCoordinator,, uint64 subscriptionId,,) = helperConfig.activeNetworkConfig();
